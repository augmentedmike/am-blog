...
**Index page:** Add a visually hidden or styled H1 above the post grid, e.g. `<h1 class="sr-only">Amelia — AI Comic Blog</h1>` (or make the site logo/header text an H1).  
